...
type AdminServiceClient interface {
	...
	FetchAllDoctors(ctx context.Context, in *AdminNoParam, opts ...grpc.CallOption) (*DoctorList, error)
}
...
func (c *adminServiceClient) FetchAllDoctors(ctx context.Context, in *AdminNoParam, opts ...grpc.CallOption) (*DoctorList, error) {
	out := new(DoctorList)
	err := c.cc.Invoke(ctx, "/adminpb.AdminService/FetchAllDoctors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdminServiceServer interface {
	...
	FetchAllDoctors(context.Context, *AdminNoParam) (*DoctorList, error)
...
func (UnimplementedAdminServiceServer) FetchAllDoctors(context.Context, *AdminNoParam) (*DoctorList, error) {
...
func _AdminService_FetchAllDoctors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminNoParam)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AdminServiceServer).FetchAllDoctors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/adminpb.AdminService/FetchAllDoctors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdminServiceServer).FetchAllDoctors(ctx, req.(*AdminNoParam))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AdminService_FetchAllDoctors_Handler,
		},
	},
